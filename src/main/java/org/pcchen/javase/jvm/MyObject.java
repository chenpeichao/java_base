...
public class MyObject {
    ...
    public static void main1(String[] args) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
...
//        String w = "wojiushiwo";
//        while(true) {
//            w += w + new Random().nextInt(8888888) + new Random().nextInt(99999999);
//        }
